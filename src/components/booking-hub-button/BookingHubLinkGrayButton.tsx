...
/**
 * **Link gray** — Figma `Buttons/Button` hierarchy **Link gray** (xl + icon `False`):
 * Default `3287:428603`, Hover `3287:428771`, Focused `3287:428715`, Disabled `3287:428659`.
 * **No fill** on default/hover/focus/loading — hover is **Gray/700** `#414651` + **underline**; icons **Gray/500** `#717680` on hover;
 * default label **Gray/600** `#535862`, icons **Gray/400** `#A4A7AE`; focus **ring only** (`BH_BTN_FOCUS_RING_TERTIARY`) + **4px** corner on focus ring slot per Figma Focused.
 *
 * @see `src/design-system/booking-hub-figma/specs/booking-hub-link-gray-link-color-buttons-figma-mcp-pull.md`
 */
export const BookingHubLinkGrayButton = forwardRef<HTMLButtonElement, BookingHubButtonBaseProps>(
  function BookingHubLinkGrayButton(
    {
      size = 'md',
      responsive = false,
      ...
      <button
        ...
        className={cn(
          ...
          !grayDisabled &&
            !busy &&
            cn(
              'text-[#535862] [&_svg]:text-[#a4a7ae]',
              'hover:bg-transparent hover:text-[#414651] hover:underline hover:decoration-solid hover:[&_svg]:text-[#717680]',
              'focus-visible:text-[#535862] focus-visible:no-underline focus-visible:[&_svg]:text-[#a4a7ae]',
            ),
          !grayDisabled && busy && 'bg-transparent text-[#535862] [&_svg]:text-[#535862]',
          className,
        )}
        onClick={onClick}
      >
...
BookingHubLinkGrayButton.displayName = 'BookingHubLinkGrayButton';
